...
(function (X, L) {
    ...
    L(a, "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        var x = u.defined, y = u.getStyle, G = u.isArray, B = u.isNumber, q = u.isObject, h = u.merge, f = u.objectEach,
            c = u.pick;
        return {
    ...
    L(a, "Core/FormatUtilities.js", [a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function (a, u) {
        function v(a, f, c, e) {
            a = +a || 0;
            f = +f;
            var h = H.lang, m = (a.toString().split(".")[1] || "").split("e")[0].length, w = a.toString().split("e"),
                n = f;
        ...
        var H = a.defaultOptions, x = a.defaultTime, y = u.getNestedProperty, G = u.isNumber, B = u.pick, q = u.pInt;
        return {
    ...
    L(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
        var v = a.animate, B = a.animObject, q = a.stop, h = H.deg2rad, f = H.doc, c = H.noop, e = H.svg, t = H.SVG_NS,
            m = H.win, w = y.addEvent, n = y.attr, l = y.createElement, J = y.css, K = y.defined, A = y.erase,
            p = y.extend, d = y.fireEvent, k = y.isArray, b = y.isFunction, g = y.isNumber, r = y.isString, F = y.merge,
        ...
        a = function () {
            ...
            a.prototype.complexColor = function (b, g, z) {
                ...
                d(this.renderer, "complexColor", {args: arguments}, function () {
                    ...
                    if (r) {
                        ...
                        e = b.stops;
                        n = z.radialReference;
                        k(a) && (b[r] = a = {x1: a[0], y1: a[1], x2: a[2], y2: a[3], gradientUnits: "userSpaceOnUse"});
            ...
            a.prototype.setTextPath = function (b, d) {
                var k = this.element, Q = this.text ? this.text.element : k, r = {textAnchor: "text-anchor"}, a = !1,
                    l = this.textPathWrapper, I = !l;
            ...
            a.prototype.titleSetter = function (b) {
                var d = this.element, g = d.getElementsByTagName("title")[0] || f.createElementNS(this.SVG_NS, "title");
            ...
            return {
                arc: v, callout: function (a, q, h, f, c) {
                    ...
                    return w
                                     ...
                                     q, h, f) {
                    return v(a + h / 2, q + f / 2, h / 2, f / 2, {start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1})
                ...
                if (h) {
                    var m = function (f, l) {
                        var n = f.textContent || "", w = n.replace(/([^\^])-/g, "$1- ").split(" "),
                            m = !a.noWrap && (1 < w.length || 1 < c.element.childNodes.length), p = a.getLineHeight(l),
                            d = 0, k = c.actualWidth;
    ...
    L(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, u, E) {
        var v = this && this.__extends || function () {
            ...
            }(), x = a.isFirefox, y = a.isMS, G = a.isWebKit, B = a.win, q = E.css, h = E.defined, f = E.extend, c = E.pick,
            e = E.pInt;
        return function (a) {
            function m() {
                            ...
                            l.reverse().forEach(function (a) {
                                ...
                                B(a, {
                                    classSetter: function (b) {
                                        ...
                                        l[0].div && h.on.apply({element: l[0].div, onEvents: h.onEvents}, arguments);
                                        return a
    ...
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, E) {
        var v = u.deg2rad, x = E.clamp, y = E.correctFloat, G = E.defined, B = E.destroyObjectProperties, q = E.extend,
            h = E.fireEvent, f = E.isNumber, c = E.merge, e = E.objectEach, t = E.pick;
        u = function () {
            ...
            m.prototype.addLabel = function () {
                var c = this, e = c.axis, l = e.options, m = e.chart, K = e.categories, A = e.logarithmic, p = e.names,
                    d = c.pos, k = t(c.options && c.options.labels, l.labels), b = e.tickPositions, g = d === b[0],
                    r = d === b[b.length - 1], F = (!k.step || 1 === k.step) && 1 === e.tickInterval;
                b = b.info;
                var D = c.label, M;
    ...
    L(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Color/Palette.js"], a["Core/DefaultOptions.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Axis/Tick.js"]], function (a, u, E, H, x, y, G, B, q) {
        var h = a.animObject, f = x.registerEventOptions, c = y.deg2rad, e = H.defaultOptions, t = G.arrayMax,
            m = G.arrayMin, w = G.clamp, n = G.correctFloat, l = G.defined, J = G.destroyObjectProperties, v = G.erase,
        ...
        a = function () {
            ...
            a.prototype.defaultLabelFormatter = function (b) {
                ...
                var d = g(this.value) ? this.value : NaN, c = a.chart.time, k = this.dateTimeLabelFormat, r = e.lang,
                    l = r.numericSymbols;
            ...
            a.prototype.setTickInterval = function (b) {
                var a = this, c = a.chart, r = a.logarithmic, e = a.options, f = a.isXAxis, h = a.isLinked,
                    F = e.tickPixelInterval, z = a.categories, p = a.softThreshold, M = e.maxPadding, m = e.minPadding,
                    t = e.tickInterval, q = g(a.threshold) ? a.threshold : null;
            ...
            a.prototype.renderUnsquish = function () {
                var b = this.chart, a = b.renderer, d = this.tickPositions, g = this.ticks, c = this.options.labels,
                    ...
                    f = Math.max(1, Math.round(l - 2 * c.padding)), h = {}, F = this.labelMetrics(), D = k.textOverflow,
                    C = 0;
                r(c.rotation) ||
            ...
            a.prototype.getTitlePosition = function () {
                var b = this.horiz, a = this.left, g = this.top, c = this.len, k = this.options.title, e = b ? a : g,
                    r = this.opposite, l = this.offset, f = k.x, h = k.y, F = this.axisTitle,
                ...
                b = {x: b ? c + f : a + (r ? this.width : 0) + l + f, y: b ? a + h - (r ? this.height : 0) + l : c + h};
        ...
        a = function () {
            ...
            a.prototype.drag = function (a) {
                var d = this.chart, b = d.options.chart, c = this.zoomHor, e = this.zoomVert, f = d.plotLeft,
                    ...
                    q = b.panKey && a[b.panKey + "Key"], w = a.chartX, A = a.chartY, J = this.selectionMarker;
            ...
            a.prototype.pinchTranslateDirection = function (a, c, b, g, e, f, l, h) {
                var d = this.chart, k = a ? "x" : "y", r = a ? "X" : "Y", F = "chart" + r, p = a ? "width" : "height",
                    m = d["plot" + (a ? "Left" : "Top")], D = d.inverted, t = d.bounds[a ? "h" : "v"],
                    n = 1 === c.length, M = c[0][F], q = !n && c[1][F];
                c = function () {
    ...
    L(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"],
        ...
        u = function () {
            ...
            g.prototype.animateBeforeDestroy = function () {
                ...
                c.plural.forEach(function (b) {
                    a[b].forEach(function (b) {
                        b.element && b.animate(e({x: a.startXPos}, b.startYPos ? {x: b.startXPos, y: b.startYPos} : {}))
                    })
                })
            };
            ...
            g.prototype.optionsToObject = function (a) {
                var b = {}, d = this.series, c = d.options.keys, e = c || d.pointArrayMap || ["y"], f = e.length, k = 0,
                    h = 0;
            ...
            g.prototype.setState = function (b, d) {
                var c = this.series, g = this.state, f = c.options.states[b || "normal"] || {},
                    ...
                    r = k && k.states && k.states[b || "normal"] || {}, m = !1 === r.enabled, n = c.stateMarkerGraphic,
                    F = this.marker || {}, w = c.chart, v = c.halo, A, J = k && c.markerAttribs;
                b = b || "";
    ...
    L(a, "Core/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
        ...
        var d = function () {
            ...
            a.prototype.renderItem = function (a) {
                var b = this.chart, d = b.renderer, c = this.options, e = this.symbolWidth, f = c.symbolPadding || 0,
                    k = this.itemStyle, h = this.itemHiddenStyle,
            ...
            a.prototype.render = function () {
                var a = this.chart, d = a.renderer, c = this.group, e = this.box, f = this.options, k = this.padding;
                this.itemX = k;
                ...
                0 < h && 0 < m && (e[e.isNew ? "attr" : "animate"](e.crisp.call({}, {x: 0, y: 0, width: h, height: m},
    ...
    L(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/FormatUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend.js"], a["Core/MSPointer.js"],
        ...
        var w = a.animate, n = a.animObject, l = a.setAnimation, v = E.numberFormat, K = H.registerEventOptions,
            ...
            fa = t.splat, ea = t.syncTimeout, ka = t.uniqueKey;
        a = function () {
            function a(a, b, d) {
            ...
            a.prototype.redraw = function (a) {
                ...
                var b = this.hasCartesianSeries ? this.axes : this.colorAxis || [], d = this.series, c = this.pointer,
                    ...
                    I = this.isDirtyBox, r = this.isDirtyLegend;
                this.setResponsive &&
            ...
            a.prototype.drawChartBox = function () {
                var a = this.options.chart, b = this.renderer,
                    ...
                    n = this.clipBox, P = this.chartBackground, w = this.plotBackground, q = this.plotBorder, A,
                    v = "animate";
    ...
    L(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Series/Point.js"],
        ...
        var f = a.animObject, c = a.setAnimation, e = u.registerEventOptions, t = E.hasTouch, m = E.svg, w = E.win,
            ...
            D = h.find, M = h.fireEvent, C = h.getNestedProperty, O = h.isArray, S = h.isNumber, W = h.isString,
            Y = h.merge, L = h.objectEach, z = h.pick, Q = h.removeEvent,
        ...
        a = function () {
            ...
            a.prototype.setOptions = function (a) {
                ...
                c.length && b(c[c.length - 1].value) && c.push(d ? {} : {color: this.color, fillColor: this.fillColor});
            ...
            a.prototype.setData = function (a, b, d, c) {
                var e = this, g = e.points, f = g && g.length || 0, k, l = e.options, h = e.chart, p = l.dataSorting,
                    m = null, t = e.xAxis;
                m = l.turboThreshold;
                var I = this.xData, n = this.yData, q = (k = e.pointArrayMap) && k.length, w = l.keys, A = 0, v = 1, C;
                a = a || [];
                k = a.length;
                b = z(b, !0);
            ...
            a.prototype.generatePoints = function () {
                var a = this.options, b = a.data, d = this.data, c, e = this.processedXData, g = this.processedYData,
                    f = this.pointClass, k = e.length, l = this.cropStart || 0, h = this.hasGroupedData, r = a.keys,
                    m = [], p;
            ...
            a.prototype.translate = function () {
                ...
                var a = this.options, d = a.stacking, c = this.xAxis, e = c.categories, g = this.enabledDataSorting,
                    ...
                    t = this.pointPlacementToXValue(), n = !!t, q = a.threshold, w = a.startFromThreshold ? q : 0, A,
                    v = this.zoneAxis || "y", C = Number.MAX_VALUE;
                for (m = 0; m < h; m++) {
            ...
            a.prototype.destroy = function (a) {
                var b =
                    this, d = b.chart, c = /AppleWebKit\/533/.test(w.navigator.userAgent), e, f, k = b.data || [], l, p;
                M(b, "destroy");
                this.removeEvents(a);
            ...
            a.prototype.update = function (a, b) {
                ...
                var c = this, e = c.chart, g = c.userOptions, f = c.initialType || c.type, k = e.options.plotOptions,
    ...
    L(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Mixins/LegendSymbol.js"],
        ...
        H = function (a) {
            ...
            c.prototype.getGraphPath = function (a) {
                var c = G.prototype.getGraphPath, e = this.options, f = e.stacking, n = this.yAxis, l, q = [], v = [],
                    u = this.index, p = n.stacking.stacks[this.stackKey], d = e.threshold,
        ...
        B = function (a) {
            ...
            d.prototype.translate = function () {
                ...
                var k = a.xAxis, l = a.yAxis, h = c.threshold, p = a.translatedThreshold = l.getThreshold(h),
                    ...
                    v = a.barW = Math.max(q, 1 + 2 * f), u = a.pointXOffset = n.offset, w = a.dataMin, x = a.dataMax;
                d.inverted && (p -= .5);
            ...
            d.prototype.pointAttribs = function (a, d) {
                ...
                var e = c.stroke ||
                    "borderColor";
                var g = c["stroke-width"] || "borderWidth", k = a && a.color || this.color, l = a && a[e] || b[e] || k,
    ...
    L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y, G) {
        ...
        var h = G.arrayMax, f = G.clamp, c = G.defined, e =
                G.extend, t = G.fireEvent, m = G.isArray, w = G.merge, n = G.objectEach, l = G.pick, J = G.relativeLength,
            K = G.splat, A = G.stableSort;
        "";
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
            ...
            var a = this, d = a.data, e, b = a.chart, f = a.options.dataLabels || {}, m = f.connectorPadding, n,
                q = b.plotWidth, t = b.plotHeight, v = b.plotLeft, u = Math.round(b.chartWidth / 3), A, y = a.center,
                B = y[2] / 2, G = y[1], z, J, K, L, X = [[], []], I, N, P, U, T = [0, 0, 0, 0],
